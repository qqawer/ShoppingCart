...
public class ShoppingCartApplicationTests  {
        ...
        void injectAllData() {
            ...
            //Product
            Product product1 =buildProduct("Apple", "The latest iPhone", "iphone15_main.jpg", "999.99", "iPhone 15 Pro");
            productRepository.save(product1);
            Product product2 =buildProduct("Samsung", "The newest Galaxy phone", "samsung_galaxy_s23.jpg", "899.99", "Samsung Galaxy S23");
            productRepository.save(product2);
            Product product3 =buildProduct("Apple", "16-inch MacBook Pro", "macbook_pro_16.jpg", "2499.99", "MacBook Pro 16");
            productRepository.save(product3);
            Product product4 =buildProduct("Nike", "Classic Air Max sneakers", "nike_air_max.jpg", "129.99", "Nike Air Max");
            productRepository.save(product4);
            Product product5 =buildProduct("Mr. Coffee", "Programmable coffee maker", "coffee_maker.jpg", "79.99", "Coffee Maker");
            productRepository.save(product5);
            Product product6 =buildProduct("Sony", "Noise-cancelling wireless headphones", "wireless_headphones.jpg", "199.99", "Wireless Headphones");
            productRepository.save(product6);
            Product product7 =buildProduct("Gaiam", "Non-slip yoga mat", "yoga_mat.jpg", "39.99", "Yoga Mat");
            productRepository.save(product7);
            Product product8 =buildProduct("TaoTronics", "LED desk lamp with USB charging", "desk_lamp.jpg", "49.99", "Desk Lamp");
        ...
        private Product buildProduct(String brand, String description,
                                     String mainImage, String price, String productName) {
